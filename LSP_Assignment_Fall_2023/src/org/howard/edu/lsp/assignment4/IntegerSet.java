...
public class IntegerSet {
	...
	public void add(int item) {
		if (!set.contains(item)) {
			...
			System.out.println("Integer " + item + " already in set");
		}
	}
	...
	public int largest() {
		try {
			...
			System.out.println(e + ": Cannot find largest element in empty set.");
		}
		return 0;
	}
	...
	public int smallest() {
		try {
			...
			System.out.println(e + ": Cannot find smallest element in empty set.");
		}
		return 0;
	}
	...
	public void remove(int item) {
		try {
			...
			System.out.println(e + ": Item not found in set.");
		}
	}
